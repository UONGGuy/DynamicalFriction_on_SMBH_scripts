...
xy_cf = gaussian_filter(xy_cf, sigma = box_half_width/1)
...
ax[1].title.set_text('SURFACE DENSITY')
...
if run_type == 0 or run_type == 2:
        fig1.savefig('./BH_plots/BH_wake_DM_' + f'{N_DM:.0e}' + '_snap_' + f'{snap_no:03d}' + '_BH.pdf', dpi=600, bbox_inches='tight')
